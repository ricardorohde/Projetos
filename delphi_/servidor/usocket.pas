...
var mensagem,
    IpDestino : string;
    lcDescr : TCriptografia;
begin
  lcDescr := TCriptografia.create;
  try
    mensagem := lcDescr.DesCriptografaTexto(Socket.ReceiveText);
  finally
    freeandNil(lcDescr);
  end;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        Mensagem := lcCrip.CriptografaTexto(Mensagem);
