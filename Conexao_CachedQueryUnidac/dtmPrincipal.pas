...
uses
  ...
  UniProvider, ODBCUniProvider, ASEUniProvider, DBAccess, Uni, MemDS;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        begin
          close;
          parambyname('CdTipo_Dominio').asInteger := viCdTipo_Dominio;
          open;
          if not eof then
          begin
