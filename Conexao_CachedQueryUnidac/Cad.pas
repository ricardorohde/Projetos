...
begin
  ...
  try
    ...
    if Assigned(Retorno) and ( ModalResult = mrOk ) then
      Carrega_QueryResult(TUniQuery(dsMain.Dataset), Retorno);
  except
    on E : Exception do
    begin
      Action := caNone;
    ...
    begin
      try
        ...
        begin
          ...
          begin
             dmPrincipal.con.StartTransaction;
             vbTransacao := true;
          end;
        ...
        begin
          ...
          Carrega_QueryResult(TUniQuery(dsMain.Dataset), vQueryResult);
          if (vbTransacao) and
             (dmPrincipal.con.InTransaction) then
          begin
             dmPrincipal.con.RollBack;
          end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        ParamByName(vaCampos[i].NOCAMPO).asString := dsMain.Dataset.FieldByName(vaCampos[i].NOCAMPO).asString;
      end;
    end;
