...
type
  TForm1 = class(TForm)
    ...
    SetupMemData1Chassi: TStringField;
    tv2CdEmpresa: TcxGridDBColumn;
    tv2NmEmpresa: TcxGridDBColumn;
    tv2VlIcms: TcxGridDBColumn;
    tv2Chassi: TcxGridDBColumn;
