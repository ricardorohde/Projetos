...
uses
  ...
  Db, uTool, Lookupedit, declaratype, DBGridPesquisa,CriaSQL;

type
  TFindEditor = class(TForm)
    pgMain: TPageControl;
    tsPast1: TTabSheet;
    mePro: TMemo;
    paPro: TPanel;
  ...
  public
    ...
    procedure SetValue(FindParam : TLookUpParam; pDatabaseName : String);
...
{TFindEditor}
procedure TFindEditor.SetValue(FindParam : TLookUpParam; pDatabaseName, pSessionName : String);
var
  I : Byte;
begin
  FFindAux := FindParam;
...
procedure TFindEditor.GetValue(var FindParam : TLookUpParam);
begin
  FindParam := FFindAux;
...
procedure TFindEditor.btnPriorClick(Sender: TObject);
begin
  with pgMain do
  begin
...
procedure TFindEditor.btnNextClick(Sender: TObject);
begin
  with pgMain do
  begin
    Self.Width := DEF_WIDTH_OLD;
...
procedure TFindEditor.FormCreate(Sender: TObject);
begin
  pgMain.ActivePage := tsPast1;
  paProTop.Caption := pgMain.ActivePage.Caption;
end;

procedure TFindEditor.meProChange(Sender: TObject);
begin
  btnNext.Enabled := (Trim(mePro.Text) <> '');
end;

procedure TFindEditor.sbUpClick(Sender: TObject);
var
  sAux : string;
  iAux : Integer;
  Obj : TObject;
...
procedure TFindEditor.sbDownClick(Sender: TObject);
var
  sAux : string;
  iAux : Integer;
  Obj : TObject;
...
procedure TFindEditor.btnOkClick(Sender: TObject);
begin
...
procedure TFindEditor.ParseSQL;
var
  I, Ini, Fim : Integer;
...
procedure TFindEditor.GetListFields(qy: TQuery; List: TStrings; Detail : boolean);
var
  I : Integer;
begin
...
function TFindEditor.ExistField(Value : string) : boolean;
var
  I : Integer;
  sAux : string;
begin
...
function TFindEditor.ExistDetail(Value : string; Detail : Boolean) : boolean;
var
  I : Integer;
  sAux : string;
begin
...
procedure TFindEditor.lbResultKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
  Aux : String;
begin
...
procedure TFindEditor.btnAdicionarClick(Sender: TObject);
var
...
procedure TFindEditor.FormShow(Sender: TObject);
begin
  mePro.SetFocus;
end;

procedure TFindEditor.lbFieldsKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFindEditor.MakeGrid;
var
  I : Integer;
  ColAux : TColumn;
begin
...
procedure TFindEditor.ClearFields;
begin
...
procedure TFindEditor.UndeleteProperty(Value : String);
begin
...
procedure TFindEditor.EnableButton;
begin
  btnAdicionar.Enabled := ((lbFields.ItemIndex <> -1) and (edtTitle.Text <> '')) or
                          (ckChave.Checked or ckKey.Checked or ckCalc.Checked);
end;

procedure TFindEditor.lbFieldsClick(Sender: TObject);
begin
  EnableButton;
end;

procedure TFindEditor.FinalizarFind;
var
  I : Integer;
begin
...
procedure TFindEditor.spdAddRelClick(Sender: TObject);
begin
...
procedure TFindEditor.spbDelRelClick(Sender: TObject);
var
  sAux : String;
begin
...
procedure TFindEditor.ckChaveClick(Sender: TObject);
begin
  EnableButton;
...
procedure TFindEditor.ckGridClick(Sender: TObject);
begin
  EnableButton;
...
procedure TFindEditor.lbRelationKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
  sAux : ShortString;
begin
...
procedure TFindEditor.ckCalcClick(Sender: TObject);
begin
...
procedure TFindEditor.btCancelarClick(Sender: TObject);
begin
   modalResult := mrCancel;
end;

procedure TFindEditor.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFindEditor.MakeQuery(qy : TQuery);
begin
...
procedure TFindEditor.btCriaSQLClick(Sender: TObject);
begin
