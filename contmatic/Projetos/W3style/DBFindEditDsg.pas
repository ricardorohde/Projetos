...
type
  ...
  private
    ...
    procedure ParseSQL;
    procedure MakeQuery(qy: TADOQuery);
  public
    { Public declarations }
...
//    FSessionName : String;
    ...
    procedure SetValue(FindParam : TLookUpParam; pConnection : TADOConnection);
...
//  begin
     ...
     begin
       SetValue(TDBFindEdit(Component).FLookUpParam, TDBFindEdit(Component).Connection);
...
{TFrmFindEditor}
procedure TfrmFindEditor.SetValue(FindParam : TLookUpParam; pConnection : TADOConnection);
var
  I : Byte;
begin
  FFindAux := FindParam;
...
procedure TfrmFindEditor.GetListFields(qy: TADOQuery; List: TStrings; Detail : boolean);
var
  I : Integer;
begin
...
procedure TfrmFindEditor.MakeQuery(qy : TADOQuery);
begin
