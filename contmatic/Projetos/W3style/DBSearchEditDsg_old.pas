...
type
  ...
  public
    ...
    procedure SetValue(SearchParam : TLookUpParam; pDatabaseName, pSessionName : String);
...
//  begin
     ...
     begin
       SetValue(TDBSearchEdit(Component).FLookUpParam, TDBSearchEdit(Component).MasterDatabase, TDBSearchEdit(Component).SessionName);
...
{TfrmSearchEditor}
procedure TfrmSearchEditor.SetValue(SearchParam : TLookUpParam; pDatabaseName, pSessionName : String);
var
  I : Byte;
begin
...
procedure TfrmSearchEditor.GetListFields(qy: TQuery; List: TStrings; Detail : boolean);
var
  I : Integer;
begin
