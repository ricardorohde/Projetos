...
type
  ...
  public
    ...
    procedure SetValue(CacheParam : TCacheParams; pDatabaseName, pSessionName : String);
...
begin
  ...
  begin
    ...
    SetValue(TCacheQuery(Component).FCacheParam, TCacheQuery(Component).DatabaseName, TCacheQuery(Component).SessionName);
...
procedure TfrmCacheryEditor.SetValue(CacheParam : TCacheParams; pDatabaseName, pSessionName : String);
begin
