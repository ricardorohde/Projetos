...
//    procedure SetSessionName(const Value: string);virtual;
  ...
  public
    ...
    //property MasterDatabase : string read GetDatabase write SetDatabase;
...
//  qy.CachedUpdates := false;
//  qy.RequestLive := False;
...
function TLookupEdit.GetConnection: TADOConnection;
begin
  result := FConnection;
end;
