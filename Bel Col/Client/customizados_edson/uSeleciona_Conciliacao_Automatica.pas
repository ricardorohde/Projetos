...
type
  ...
  private
    ...
    procedure DeleteOrEditMovimentoBancario(psEmpresa, psFilial: string; pbIsEdit: Boolean = True);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          DeleteOrEditMovimentoBancario(lsEmpresa, lsFilial, False);
...
procedure TfrmSeleciona_Conciliacao_Automatica.DeleteOrEditMovimentoBancario(psEmpresa, psFilial: string; pbIsEdit: Boolean = True);
var
  lsSQL: string;
begin
  ...
  lsSQL := lsSQL + 'VALOR = :VALOR AND DOCUMENTO = :DOCUMENTO ';
  ...
  begin
    ...
    begin
      DataType  := ftFloat;
      ParamType := ptInput;
      AsFloat   := cdsEfetiva_Movimentos.FieldByName('VALOR').AsFloat;;
    end;

    with ParamByName('DOCUMENTO') do
    begin
      DataType  := ftString;
      ParamType := ptInput;
      AsString  := cdsEfetiva_Movimentos.FieldByName('DOCUMENTO').AsString;;
    end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if lsStatusOld = STATUS_A_CONCILIAR then
            InserirMovimentoBancario(lsEmpresa, lsFilial)
          else
          if lsStatusOld = STATUS_ALTERADO then
            DeleteOrEditMovimentoBancario(lsEmpresa, lsFilial);
        end;
      end;
