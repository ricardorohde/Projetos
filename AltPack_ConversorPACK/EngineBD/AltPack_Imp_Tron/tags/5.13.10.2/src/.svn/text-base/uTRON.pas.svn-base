...
//      SQL.SaveToFile('C:\sql\Tron\empresa.sql');
      Open;
    end;
...
//      SQL.SaveToFile('C:\sql\Tron\socio.sql');
      Open;
    end;
...
//      SQL.SaveToFile('C:\sql\Tron\VinculoSocio.sql');
      Open;
    end;
...
//      SQL.SaveToFile('C:\sql\Tron\empresaDP.sql');
      Open;
    end;
...
//      SQL.SaveToFile('C:\sql\Tron\Banco.sql');
      Open;
    end;
...
begin
  with qryTron do
    begin
      ...
      SQL.Add('FROM ' + cTableName + ';          ');
//      SQL.SaveToFile('C:\sql\Tron\Departamento.sql');
      Open;
    end;
...
//      SQL.SaveToFile('C:\sql\Tron\Horario.sql');      
      Open;
    end;
...
//      SQL.SaveToFile('C:\sql\Tron\Funcao.sql');
      Open;
    end;
...
//      SQL.SaveToFile('C:\sql\Tron\Funcionario.sql');
      Open;
    end;
...
//      SQL.SaveToFile('C:\sql\Tron\Dependente.sql');
      Open;
    end;
...
//      SQL.SaveToFile('C:\sql\Tron\Especial.sql');      
      Open;
    end;
...
//      SQL.SaveToFile('C:\sql\Tron\Sindicato.sql');
      Open;
    end;
...
//      SQL.SaveToFile('C:\sql\Tron\AjusteSalarial.sql');
      Open;
    end;
...
//      SQL.SaveToFile('C:\sql\Tron\Contribuinte.sql');
      Open;
    end;
...
//      SQL.SaveToFile('C:\sql\Tron\Afastamento.sql');
      Open;
    end;
