...
type
  ...
  private
    ...
    function GetDPReajusteSalarial(AIdEmpresa : Integer) : TDataSet;

    // Retorna 'DataSet' para validação do 'WInss'.
    function GetINSSContribuinteSocio(AIdEmpresa : Integer) : TDataSet;
...
function TTRON.GetDPReajusteSalarial(AIdEmpresa: Integer): TDataSet;
const
...
begin
  with qryTron do
    begin
      ...
      SQL.Add('  AND ' + cTableName03 + '.codempfol = ' + IntToStr(AIdEmpresa)         );
...
function TTRON.GetINSSContribuinteSocio(AIdEmpresa: Integer): TDataSet;
const
  cTableName01 : string = 'TBLSCORSP';
  cTableName02 : string = 'TBLCID';
  cTableName03 : string = 'TBLSCORSPEMP';
...
begin
  with qryTron do
    begin
      ...
      SQL.Add('WHERE ' + cTableName01 + '.codcid = ' + cTableName02 + '.codcid      ');
      SQL.Add('  AND ' + cTableName01 + '.codscorsp = ' + cTableName03 + '.codscorsp');
      SQL.Add('  AND ' + cTableName03 + '.codemp = ''' + IntToStr(AIdEmpresa) + ''';');
      Open;
    end;
