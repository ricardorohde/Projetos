...
type
  ...
  private
    ...
    function GetPHDVinculoSocio : TDataSet;

    // Retornar 'DataSet' para validação do 'WDp'.
    function GetDPEmpresa : TDataSet;
    function GetDPDepartamento : TDataSet;
    function GetDPSindicato : TDataSet;
    function GetDPFuncao : TDataSet;
    function GetDPHorario : TDataSet;
    function GetDPBanco : TDataSet;
    function GetDPFuncionario(AIdEmpresa : Integer) : TDataSet;
    function GetDPDependente(AIdEmpresa : Integer) : TDataSet;
    function GetDPEspecial : TDataSet;
    function GetDPAfastamento(AIdEmpresa : Integer) : TDataSet;
    function GetDPFerias(AIdEmpresa : Integer) : TDataSet;
    function GetDPReajusteSalarial(AIEmpresa : Integer) : TDataSet;

    // Retorna 'DataSet' para validação do 'WInss'.
    function GetINSSContribuinteSocio(vIdEmpresa : Integer) : TDataSet;
  ...
  public
    ...
    function GetDataSetImpConcorrente(TableName: String; AIdEmpresa : Integer) : TDataSet; override;
  end;
...
function TTRON.GetDataSetImpConcorrente(TableName : String; AIdEmpresa : Integer) : TDataSet;
begin
...
function TTRON.GetPHDVinculoSocio : TDataSet;
const
...
function TTRON.GetDPDepartamento: TDataSet;
const
...
function TTRON.GetDPFuncionario(AIdEmpresa : Integer) : TDataSet;
const
...
begin
  with qryTron do
    begin
      ...
      SQL.Add('WHERE ' + cTableName04 + '.codempfol    = ' + IntToStr(AIdEmpresa)                     );
...
function TTRON.GetDPDependente(AIdEmpresa : Integer) : TDataSet;
const
...
begin
  with qryTron do
    begin
      ...
      SQL.Add('FROM ' + cTableName01 + ', ' + cTableName02 + ', ' + cTableName03   );
      SQL.Add('WHERE ' + cTableName03 + '.codempfol = ' + IntToStr(AIdEmpresa)     );
...
function TTRON.GetDPReajusteSalarial(AIEmpresa: Integer): TDataSet;
const
...
begin
  with qryTron do
    begin
      ...
      SQL.Add('FROM ' + cTableName01 + ', ' + cTableName02 + ', ' + cTableName03      );
      SQL.Add('WHERE ' + cTableName01 + '.codempfol = ' + IntToStr(AIEmpresa)         );
      SQL.Add('  AND ' + cTableName03 + '.codempfol = ' + IntToStr(AIEmpresa)         );
...
function TTRON.GetINSSContribuinteSocio(vIdEmpresa: Integer): TDataSet;
const
  cTableName01 : string = 'TBLSCORSP';
  cTableName02 : string = 'TBLCID';
  cTableName03 : string = 'TBLSCORSPEMP';
...
begin
  with qryTron do
    begin
      ...
      SQL.Add('WHERE ' + cTableName01 + '.codcid = ' + cTableName02 + '.codcid      ');
      SQL.Add('  AND ' + cTableName01 + '.codscorsp = ' + cTableName03 + '.codscorsp');
      SQL.Add('  AND ' + cTableName03 + '.codemp = ''' + IntToStr(vIdEmpresa) + ''';');
      Open;
    end;
...
function TTRON.GetDPFerias(AIdEmpresa: Integer): TDataSet;
{const
...
function TTRON.GetDPAfastamento(AIdEmpresa: Integer): TDataSet;
const
  cTableName01 : string = 'TBLMOVMEN';
