      ...
      begin
        ...
        if tblEmpTemp.FieldByName('StImporta').AsBoolean then
          begin
            ...
            if (IsCGCValid(tblEmpTemp.FieldByName('CNPJ').AsString) or IsCICValid(tblEmpTemp.FieldByName('CNPJ').AsString)) then
...
begin
  ...
  //          lValidadorDeDados.Validar('WPHD.VinculoSocio', lDataSetTemp, mmLog.Lines);
            ...
            begin
              ...
              if (lDataSetTemp <> nil) and (lDataSetTemp.RecordCount > 0) then
                begin
                  ...
                  try
                    lValidadorDeDados.MapaEmpresa.ListaEmpresa := FListaEmpresa;
                    lValidadorDeDados.Validar('WPHD.VinculoSocio', lCdEmpresaOld, lDataSetTemp, mmLog.Lines);
                  finally
                    //freeAndNil(lValidadorDeDados);
                    lValidadorDeDados.Destroy;
                  end;
        ...
        try
          ...
          for i := 0 to Length(FEmpresaList) - 1 do
            begin
              ...
              if (lDataSetTemp <> nil) and (lDataSetTemp.RecordCount > 0) then
                begin
                  lValidadorDeDados.Validar('WINSS.Contribuinte', lCdEmpresaOld, lDataSetTemp, mmLog.Lines);
                end;
    ...
    lImportadorAlterdataBase.Destroy;
  end;
end;
            ...
            begin
              ...
              if (lDataSetTemp <> nil) and (lDataSetTemp.RecordCount > 0) then
                begin
                  ...
                  try
                    lValidadorDeDados.MapaEmpresa.ListaEmpresa := FListaEmpresa;
                    lValidadorDeDados.Validar('WDP.Departamento', lCdEmpresaOld, lDataSetTemp, mmLog.Lines);
                  finally
                    //freeAndNil(lValidadorDeDados);
                    lValidadorDeDados.Destroy;
                  end;
            ...
            begin
              ...
              if (lDataSetTemp <> nil) and (lDataSetTemp.RecordCount > 0) then
                begin
                  ...
                  try
                    lValidadorDeDados.MapaEmpresa.ListaEmpresa := FListaEmpresa;
                    lValidadorDeDados.Validar('WDP.Funcionario', lCdEmpresaOld, lDataSetTemp, mmLog.Lines);
                  finally
                    //freeAndNil(lValidadorDeDados);
                    lValidadorDeDados.Destroy;
                  end;
            ...
            begin
              ...
              if (lDataSetTemp <> nil) and (lDataSetTemp.RecordCount > 0) then
                begin
                  ...
                  try
                    lValidadorDeDados.MapaEmpresa.ListaEmpresa := FListaEmpresa;
                    lValidadorDeDados.Validar('WDP.Dependente', lCdEmpresaOld, lDataSetTemp, mmLog.Lines);
                  finally
                    //freeAndNil(lValidadorDeDados);
                    lValidadorDeDados.Destroy;
                  end;
            ...
            begin
              ...
              if (lDataSetTemp <> nil) and (lDataSetTemp.RecordCount > 0) then
                begin
                  ...
                  try
                    lValidadorDeDados.MapaEmpresa.ListaEmpresa := FListaEmpresa;
                    lValidadorDeDados.Validar('WDP.Afastamento', lCdEmpresaOld, lDataSetTemp, mmLog.Lines);
                  finally
                    //freeAndNil(lValidadorDeDados);
                    lValidadorDeDados.Destroy;
                  end;
              ...
              if (lDataSetTemp <> nil) and (lDataSetTemp.RecordCount > 0) then
                begin
                  ...
                  try
                    lValidadorDeDados.MapaEmpresa.ListaEmpresa := FListaEmpresa;
                    lValidadorDeDados.Validar('WDP.Ferias', lCdEmpresaOld, lDataSetTemp, mmLog.Lines);
                  finally
                    //freeAndNil(lValidadorDeDados);
                    lValidadorDeDados.Destroy;
                  end;
            ...
            begin
              ...
              if (lDataSetTemp <> nil) and (lDataSetTemp.RecordCount > 0) then
                begin
                  ...
                  try
                    lValidadorDeDados.MapaEmpresa.ListaEmpresa := FListaEmpresa;
                    lValidadorDeDados.Validar('WDP.Acumulado', lCdEmpresaOld, lDataSetTemp, mmLog.Lines);
                  finally
                    //freeAndNil(lValidadorDeDados);
                    lValidadorDeDados.Destroy;
                  end;
            ...
            begin
              ...
              if (lDataSetTemp <> nil) and (lDataSetTemp.RecordCount > 0) then
                begin
                  ...
                  try
                    lValidadorDeDados.MapaEmpresa.ListaEmpresa := FListaEmpresa;
                    lValidadorDeDados.Validar('WDP.ReajusteSalarial', lCdEmpresaOld, lDataSetTemp, mmLog.Lines);
                  finally
                    //freeAndNil(lValidadorDeDados);
                    lValidadorDeDados.Destroy;
                  end;
            ...
            begin
              ...
              if (lDataSetTemp <> nil) and (lDataSetTemp.RecordCount > 0) then
                begin
                  ...
                  try
                    lValidadorDeDados.MapaEmpresa.ListaEmpresa := FListaEmpresa;
                    lValidadorDeDados.Validar('WINSS.Acumulado', lCdEmpresaOld, lDataSetTemp, mmLog.Lines);
                  finally
                    //freeAndNil(lValidadorDeDados);
                    lValidadorDeDados.Destroy;
                  end;
            ...
            begin
              ...
              if (lDataSetTemp <> nil) and (lDataSetTemp.RecordCount > 0) then
                begin
                  ...
                  try
                    lValidadorDeDados.MapaEmpresa.ListaEmpresa := FListaEmpresa;
                    lValidadorDeDados.Validar('WCONT.LancamentoTemporario', lCdEmpresaOld, lDataSetTemp, mmLog.Lines);
                  finally
                    //freeAndNil(lValidadorDeDados);
                    lValidadorDeDados.Destroy;
                  end;
