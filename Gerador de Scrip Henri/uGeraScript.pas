...
begin
  if not (StrToIntDef(edtEmpresa.Text,-1) = -1) then
    begin
    ...
    begin
      ShowMessage('Empresa não informada ou valor inválido.Verifique!!!');
      edtEmpresa.SetFocus;
    end;
end;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          lcStringList2.Add('INSERT INTO HE02 (HE02_NR_EMPRESA,HE02_ST_MATRICULA, HE02_ST_PIS, HE02_ST_NOME) VALUES (' + IntToStr(StrToInt(edtEmpresa.Text))+ ','+QuotedStr(lcCodigo)+','+QuotedStr(lcPis)+','+QuotedStr(UpperCase(TrimRight(lcNome)))+');');
          result := True;
        end;
      end;
    end;
    ...
    if result then
      lcStringList2.SaveToFile(ExtractFilePath(pArquivo)+ 'Empresa'+edtEmpresa.Text+'.txt');
