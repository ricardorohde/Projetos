...
uses
  ...
  DB, DBClient, Grids, DBGrids,LIB, ToolWin, ImgList, alterdata_skin,
  alterdata_nxskin;
...
type
  TfrmPrincipal = class(TForm)
    ...
    ToolBar1: TToolBar;
    Configuracoes: TToolButton;
    ToolButton2: TToolButton;
    AltNxVclSkin1: TAltNxVclSkin;
...
uses uCadastroUsuario, uConfiguracao;
...
begin
  try
    ...
    Client.Socket.SendText(IpDestino + '*'+Client.Socket.LocalAddress +':IP'+ FnmComputador +','+ edtTexto.text);
